...
public class EventSimulator {
    //медведь поспал - +15 энергии,+//медведь бегает - -8 энергии+//медведь съел малину -2 энергии+5здоровья,+
    // медведь съел зайца - 5, + хелс(коэффициент * наздоровье),+// напал охотник - 20,+
    //медведь ловит рыбу - 10 энергии, + 5 здоровья,// ползал на дерево- -6 энергии
    //медведь съел лося - 20 энергии, + 15 здоровья.// купался в реке - 7 энергии//медведь ел мед - 10 энергии, + 8 здровья
    ...
    public void startSimulator(Bear bear) {
        ...
        private void sleepEvent (Bear bear){  //сон медведя
            int energy = bear.getEnergy();   //выгружаем энергию
            int health = bear.getHealth();                              //получаем текущую энергию
            energy = energy + 10;
        ...
        private void runningEvents (Bear bear){  // медведь бегал
        ...
        private void eatsEaspberries (Bear bear){  //  ел малину//eatsEaspberries
            int energy = bear.getEnergy();
